...
public class MapperTest {
    ...
    public void testSelectUser() {
        User user = userMapper.selectById(200);
        System.out.println(user);

//        user = userMapper.selectByName("lijuncai");
//        System.out.println(user);
//
//        user = userMapper.selectByEmail("lijuncai001@gmail.com");
//        System.out.println(user);
    }
    ...
    public void updateUser() {
        ...
        rows = userMapper.updateHeader(150, "icon.png");
        System.out.println(rows);
    ...
    public void testInsertLoginTicket() {
        ...
        loginTicket.setTicket("test_ticket");
    ...
    public void testSelectLoginTicket() {
        LoginTicket loginTicket = loginTicketMapper.selectByTicket("test_ticket");
        System.out.println(loginTicket);

        loginTicketMapper.updateStatus("test_ticket", 1);
        loginTicket = loginTicketMapper.selectByTicket("test_ticket");
        System.out.println(loginTicket);
    }
